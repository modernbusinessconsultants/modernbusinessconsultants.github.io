...
- Domain: [modernbusinessconsultants.com](https://modernbusinessconsultants.com)
- Hosting: GitHub Pages (`main` branch, site root)
...
Older service and package pages may still exist in the repo but are not linked in navigation.
